...
subtitle: "Модель боевых действий - вариант 41"
...
В начальный момент времени страна $X$ имеет армию численностью 32500 человек, 
а в распоряжении страны $Y$ армия численностью в 13800 человек.
...
$$
 \begin{cases}
	\frac{dx}{dt}= -0.28(t) - 0.8y(t) + |sin(2t)|
	\\   
	\frac{dy}{dt}= -0.4x(t)y(t) - 0.27y(t) + |cos(t)|
 \end{cases}
$$
